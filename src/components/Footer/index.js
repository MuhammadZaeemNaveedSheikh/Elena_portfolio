...
import { FaInstagram, FaMailBulk,FaGithub,FaLinkedin,FaGoogle } from "react-icons/fa";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Text>© 2022 Elena Korshakova. All rights reserved</Text>
          <Stack direction={"row"} spacing={6}>
            <SocialButton label={"Email"} href={"http://ekorshak@stevens.edu"} target={"_blank"}>
              <FaMailBulk />
            </SocialButton>
            ...
            <SocialButton label={"AiFillGithub"} href={"https://github.com/ElenaKorshakova"} target={"_blank"}>
              <FaGithub />
            </SocialButton>
            <SocialButton label={"Instagram"} href={"https://www.linkedin.com/in/elena-korshakova-255158181/"} target={"_blank"}>
              <FaLinkedin />
            </SocialButton>
            <SocialButton label={"Instagram"} href={"https://scholar.google.com/citations?user=gF4kRIsAAAAJ&hl=en"} target={"_blank"}>
              <FaGoogle />
            </SocialButton>
          </Stack>
        </Container>
